...
class PCHeader extends React.Component {
  ...
  //use for user when they had already loged in and clicked refresh button but didn't logout
  componentWillMount() {
      ...
      <header>
        <Row>
          ...
          <Col span={16}>
            ...
            <Modal title="User Center" wrapClassName="vertical-center-modal" visible={this.state.modalVisiable}
